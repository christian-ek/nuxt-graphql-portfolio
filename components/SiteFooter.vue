...
const links = [
  {
    name: "GitHub",
    href: "https://github.com/christian-ek",
  ...
  {
    name: "Google SCholar",
    href: "https://scholar.google.com/citations?user=42LAHqUAAAAJ&hl",
...
<template>
  <footer class="bg-gray-800">
    ...
    >
      <p class="flex-1">&copy; Christian Ek 2023. All Rights Reserved</p>
